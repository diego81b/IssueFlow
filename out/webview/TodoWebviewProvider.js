...
exports.TodoWebviewProvider = void 0;
const vscode = __importStar(require("vscode"));
class TodoWebviewProvider {
    constructor(_extensionUri, _todoManager, _githubService, _gitlabService) {
        this._extensionUri = _extensionUri;
        this._todoManager = _todoManager;
        this._githubService = _githubService;
        this._gitlabService = _gitlabService;
    }
    static createOrShow(extensionUri, todoManager, githubService, gitlabService) {
        ...
        const panel = vscode.window.createWebviewPanel(TodoWebviewProvider.viewType, 'IssueFlow - TODO Manager', column || vscode.ViewColumn.One, {
            enableScripts: true,
        ...
        panel.webview.onDidReceiveMessage(message => provider._handleMessage(message), undefined, []);
        panel.onDidDispose(() => {
    ...
    static updateAuthStatus(githubService, gitlabService) {
        if (TodoWebviewProvider._currentPanel) {
            const authStatus = {
    ...
    async _createIssues(platform, repo, todos) {
...
exports.TodoWebviewProvider = TodoWebviewProvider;
TodoWebviewProvider.viewType = 'issueflow.todoView';
function getNonce() {
    let text = '';
...
//# sourceMappingURL=TodoWebviewProvider.js.map